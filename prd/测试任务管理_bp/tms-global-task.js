...
(function(w){
  ...
  /* =========== 统一任务数据 =========== */
  /* statusClass 与 workbench 卡片保持一致：
     status-exec / status-design / status-review / status-done */
  var STATUS_STYLE = {
  ...
  var TASKS = [
    { id:"T001", code:"T-2026-001", name:"支付中心重构测试",
      statusClass:"status-exec",   statusText:"执行中",
      owner:"张小明" },
    { id:"T002", code:"T-2026-002", name:"会员体系 H5 新增优惠券模块",
      statusClass:"status-design", statusText:"设计中",
      owner:"李工程师" },
    { id:"T003", code:"T-2026-003", name:"商品搜索算法优化回归测试",
      statusClass:"status-review", statusText:"评审中",
      owner:"王测试" },
    { id:"T004", code:"T-2026-004", name:"订单履约系统性能测试",
      statusClass:"status-exec",   statusText:"执行中",
      owner:"赵架构师" },
    { id:"T005", code:"T-2026-005", name:"消息推送服务国际化改造",
      statusClass:"status-exec",   statusText:"执行中",
      owner:"孙小红" },
    { id:"T006", code:"T-2026-006", name:"用户登录安全增强验收",
